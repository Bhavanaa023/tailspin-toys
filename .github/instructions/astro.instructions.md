...
- Define a `Props` interface or type in frontmatter for every reusable component, including layouts
- Document non-obvious props and component invariants; see [`code-style.instructions.md`](code-style.instructions.md)
...
- Comment why a non-obvious UI decision exists, not what the markup already says; remove stale comments when the component changes.
